...
import { message } from "telegraf/filters"; // іморт необхідних фільтрів
...
bot.on(message("voice"), async (ctx) => {
  ...
  try {
    ...
    const userId = String(ctx.message.from.id); // зберігає ід користувача який взаємодіє з чатом (розрізняти користувачів)
